...
public class GameView {
    ...
    /**
     * @param court le "modÃ¨le" de cette vue (le terrain de jeu de raquettes et tout ce qu'il y a dessus)
     * @param root  le nÅud racine dans la scÃ¨ne JavaFX dans lequel le jeu sera affichÃ©
     * @param scale le facteur d'Ã©chelle entre les distances du modÃ¨le et le nombre de pixels correspondants dans la vue
     */
